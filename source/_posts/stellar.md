...
title: 每个人的独立博客
tags: [matery 教程 安装]
excerpt: Stellar 是一个极为强大的综合型 Hexo 主题，包含博客系统、知识库系统、专栏系统、笔记系统，内置海量的标签和动态数据组件。
categories:
index_img: /img/4.png
banner_img: /img/4.png
# sticky: 800
date: 2026-05-26 07:00:00
---
{% note success %}
是一个极为强大的综合型 Hexo 主题，包含博客系统、知识库系统、专栏系统、笔记系统，内置海量的标签和动态数据组件。
{% endnote %} 
