...
title: matery主题介绍
tags: [matery 教程 安装]
excerpt: 这是一个采用Material Design和响应式设计的 Hexo 博客主题，喜欢分类作品和写作的可以考虑
categories:
...
- [配置](#配置)
  [切换主题](#切换主题)
  [新建分类 categories 页](#新建分类-categories-页)
  [新建标签 tags 页](#新建-tags-页)
  [新建关于我 about 页](#新建关于我-about-页)
  [新建友情连接 friends 页（可选的）](#新建友情连接-friends-页可选的)
  [搜索](#搜索)
  [中文链接转拼音（可选的）](#中文链接转拼音可选的)
  [文章字数统计插件（可选的)](#文章字数统计插件可选的)
  [修改页脚](#修改页脚)
  [修改社交链接](#修改社交链接)
  [修改打赏的二维码图片](#修改打赏的二维码图片)
  [配置音乐播放器](#配置音乐播放器)
...
- [特性](#自定义修改)
  [修改主题颜色](#修改主题颜色)
  [修改文章和banner图](#修改-banner-图和文章特色图)
- [版本记录](#版本记录)
## 特性
...
喜欢原创和作品展览分类的可以考虑，不妨使用 Hexo 和 [markdwon](https://example.com) 来写博客和文章。点击 [这里](https://codeload.github.com/blinkfox/hexo-theme-matery/zip/master)下载 master 分支的最新稳定版的代码，解压缩后，将 hexo-theme-matery 的文件夹复制到你 Hexo 的 themes 文件夹中即可。
...
[{
    ...
    "avatar": "http://80tz.cn/fluid.png",
    "name": "80后技术哲学博客",
    "introduction": "不以物喜 不以己悲。",
    "url": "https://www.80tz.cn",
    "title": "前去学习"
}]
```
...
脚信息可能需要做定制化修改，而且它不便于做成配置信息，所以可能需要你自己去再修改和加工。修改的地方在主题文件的 /layout/_partial/footer.ejs 文件中，包括站点、使用的主题、访问量等
